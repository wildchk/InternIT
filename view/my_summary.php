...
require('../function.php');
	$query = "SELECT * FROM summary WHERE id_user=$id_user";
            ...
            if((!isset($_GET['search']))) {
                ...
                if ($count>6) {
                    ...
                    while ($i<$int_div_count) {
                        ...
                        if ($_GET['page'.$i]) {
                            for ($delta_j=$j-6; $delta_j < $j; $delta_j++) { 
                                if ($row[$delta_j]['id_user']==$id_user){
                                    article_summary($row, $delta_j);  
                                }
